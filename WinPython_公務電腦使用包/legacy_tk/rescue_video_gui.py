...
RESCUE_VIDEO_DIR = PACKAGE_ROOT / "rescue_video"
if str(RESCUE_VIDEO_DIR) not in sys.path:
    sys.path.insert(0, str(RESCUE_VIDEO_DIR))
...
from rescue_video_core import (
    DEFAULT_DESTINATION,
    DEFAULT_REPORT,
    DEFAULT_RUNTIME_OUTPUT_ROOT,
    DEFAULT_WORK_LOG_ROOT,
    PreflightState,
    build_args,
    choose_runtime_offset,
    evaluate_preflight,
    execution_enabled,
    format_summary,
    is_memory_card_source,
    run_classification,
    run_preflight,
    status_tag,
    summarize_results,
