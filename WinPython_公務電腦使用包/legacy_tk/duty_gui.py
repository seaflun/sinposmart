...
RUNTIME_OUTPUT_DIR = PACKAGE_ROOT / "runtime_outputs"
...
from legacy_tk.daily_vehicle_automation import start_daily_vehicle_automation
from legacy_tk.duty_sheet_automation import open_duty_sheet_dialog
from legacy_tk.rest_time_dialogs import open_monthly_base_dialog, open_rest_time_dialog
...
APP_ICON_PNG = PACKAGE_ROOT / "duty_tray_icon.png"
APP_ICON_ICO = PACKAGE_ROOT / "duty_tray_icon.ico"
APP_ICON_GIF = PACKAGE_ROOT / "duty_tray_icon.gif"
...
class DutyGui(ctk.CTk):
    ...
    def open_rescue_video_tool(self) -> None:
        tool_path = PACKAGE_ROOT / "legacy_tk" / "rescue_video_gui.py"
    ...
    def check_for_update(self) -> None:
        updater = PACKAGE_ROOT / "update_package.ps1"
